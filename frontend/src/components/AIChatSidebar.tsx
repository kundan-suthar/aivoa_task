      ...
      <div className="p-4 bg-white border-t border-slate-200 mt-auto">
        <div className="flex flex-col space-y-2">
          ...
          <div className="flex justify-end">
            <button className="p-2 bg-slate-900 text-white rounded-lg hover:bg-slate-800 transition-all shadow-md hover:shadow-lg active:scale-95 flex items-center space-x-2 px-4 group">
